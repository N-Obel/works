(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hero")) new swiper_core_Swiper(".hero", {
            ...
            parallax: true,
            navigation: {
                prevEl: ".slide-hero__arrow--prev",
                nextEl: ".slide-hero__arrow--next"
            },
            on: {}
        });
        if (document.querySelector(".slider-cargo")) new swiper_core_Swiper(".slider-cargo", {
            ...
            parallax: true,
            navigation: {
                prevEl: ".slider-cargo__arrow--prev",
                nextEl: ".slider-cargo__arrow--next"
            },
            breakpoints: {
                318: {
                    slidesPerView: 1.2,
